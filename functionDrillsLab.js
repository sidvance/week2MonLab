...
// const greeting = (person1, person2) => `${person1} says hello to ${person2}`

// console.log(greeting('Shakira', 'Pedro Pascal'))
...
let nameGreeting = nameCheck('Cassidy princess of genovia')
...
const thatsOdd = (num) => {return num % 2 === 0 ? 'That\'s not odd!' : 'That\'s odd indeed!'}
...
/*
  ...
  previous problem (give it the same name, just add a 2 to the end of it) that fixes this 
  bug. Invoke the function and store the returned value to a variable called `totalFrogs2`.
*/
